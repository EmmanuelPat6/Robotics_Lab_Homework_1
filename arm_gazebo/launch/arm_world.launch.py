...
def generate_launch_description():
    ...
    xacro_arm = os.path.join(arm_description_path, "urdf", "arm.urdf.xacro")


    #with open(xacro_arm, 'r') as infp:
    #    arm_desc = infp.read()

    #robot_description_arm = {"robot_description": arm_desc}

    robot_description_arm = {"robot_description":Command(['xacro ', xacro_arm, ' j0_pos:=0.0',' j1_pos:=0.5',' j2_pos:=0.5',' j3_pos:=1.0'])}
